...
export const ContactSection = React.memo(function ContactSection() {
  return (
    <section className="section contact-section" id="contact">
      <h2 className="section-header reveal">CONTACT</h2>
      <div className="section-subtitle reveal reveal-delay-1">// LET&apos;S CONNECT</div>
      ...
      <div className="contact-links reveal reveal-delay-2">
        {contactLinks.map((link) => (
          <a
            ...
            target={
              link.href.startsWith("http") || link.icon === "resume"
                ? "_blank"
                : undefined
            }
          >
